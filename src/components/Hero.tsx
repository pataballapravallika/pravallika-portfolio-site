      ...
      <div className="container mx-auto px-4 text-center">
        <div className="animate-fade-in">
          <div className="mb-8 flex justify-center">
            <div className="relative">
              <img
                ...
                alt="Pravallika Pataballa"
                className="w-48 h-48 rounded-full object-cover shadow-2xl border-4 border-primary/30 animate-float"
              />
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-foreground">
            Hi, I'm Pravallika <span className="animate-pulse">👋</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <Button
              onClick={onViewWork}
              size="lg"
              className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-3 text-lg font-medium rounded-full transition-all transform hover:scale-105"
            >
              View My Work
            </Button>
            ...
            <Button
              variant="outline"
              size="lg"
              className="border-primary text-primary hover:bg-primary hover:text-primary-foreground px-8 py-3 text-lg font-medium rounded-full transition-all"
